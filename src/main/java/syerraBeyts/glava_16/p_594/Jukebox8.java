package syerraBeyts.glava_16.p_594;
...
public class Jukebox8 {
    ...
    public void go() {
        ...
        System.out.println(songList);
        */
        //создаем множетво TreeSet
        //rконструктор без аргументов - для сортировки бедет использоваться
        //compareTo из каждого элемента
